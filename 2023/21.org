...
heleboel additionele tuinen maar een heel klein beetje. Die 1/8 tuin extra of minder is hetzelfde als het volledige tuintje minus een diamant, zoals de diamant die we bij Part One hebben moeten uitrekenen.

Het aantal hoekjes dat we er af moeten halen zijn alleen oneven. Het aantal hoekjes dat erbij moet is allemaal even.

+ Even 4-tal hoekjes = n
+ Onven 4-tal hoekjes = n + 1
