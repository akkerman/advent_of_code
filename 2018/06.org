...
Ik weet niet of het ik het helemaal snap.

Volgens mij grotendeels hetzelfde als eerst maar ipv een minimum tellen we alle
afstanden op en als het totaal kleiner gelijk 10k is dan hebben we een match.
En dan optellen hoeveel van die punten er zijn?
